...
//add a Sales Record
Router.post('/sales', [(0, _check.check)('name').isAlphanumeric(), (0, _check.check)('price').isNumeric(), (0, _check.check)('item').isAlphanumeric()], _salesController2.default.addSale);
